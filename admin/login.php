                ...
                if ($user) {
                    ...
                    if ($user['account_locked']) {
                        ...
                        if ($current_time->getTimestamp() - $lockout_time->getTimestamp() > ($lockout_duration * 60)) {
                            // Unlock account
                            $unlock_sql = "UPDATE Admin_login SET account_locked = FALSE, login_attempts = 0, lockout_time = NULL WHERE admin_id = ?";
                            $db->update($unlock_sql, [$user['admin_id']]);
                        } else {
                    ...
                    if (!$user['account_locked']) {
                        ...
                        if (DatabaseHelper::verifyPassword($password, $user['password_hash'])) {
                            ...
                            $update_sql = "UPDATE Admin_login SET login_attempts = 0, last_login = NOW() WHERE admin_id = ?";
                            $db->update($update_sql, [$user['admin_id']]);
                            ...
                            $lock_account = $attempts >= 3; // More strict for admin accounts
                            
                            $update_sql = "UPDATE Admin_login SET login_attempts = ?, account_locked = ?, lockout_time = ? WHERE admin_id = ?";
                            $lockout_time = $lock_account ? date('Y-m-d H:i:s') : null;
                            $db->update($update_sql, [$attempts, $lock_account, $lockout_time, $user['admin_id']]);
        ...
        <div class="login-wrapper">
            <div class="login-card">
                <div class="login-header">
                    ...
                    <h1>Admin Portal</h1>
                    <p>Hospital administration and system management</p>
                </div>
                ...
                <div class="login-footer">
                    <div class="register-link">
                        <p>Authorized personnel only. Contact system administrator for access.</p>
                    </div>
            ...
            <div class="login-info">
                ...
                <div class="info-features">
                    <div class="feature-item">
                        ...
                        <div>
                            ...
                            <p>Register and manage doctors, staff, and patient accounts.</p>
                        </div>
                    </div>
                    <div class="feature-item">
                        ...
                        <div>
                            ...
                            <p>Monitor system usage, performance, and generate reports.</p>
                        </div>
                    </div>
                    <div class="feature-item">
                        ...
                        <div>
                            ...
                            <p>Backup, restore, and maintain system data integrity.</p>
                        </div>
                    </div>
                    <div class="feature-item">
                        ...
                        <div>
                            ...
                            <p>Manage access permissions and security settings.</p>
                        </div>
                    </div>
                    <div class="feature-item">
                        <i class="fas fa-hospital"></i>
                        <div>
                            ...
                            <p>Configure hospital information and system parameters.</p>
                        </div>
                    </div>
                    <div class="feature-item">
                        ...
                        <div>
                            <h4>Audit Logs</h4>
                            <p>Review system activities and maintain compliance records.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="contact-support">
                    ...
                    <p>For critical system issues, contact emergency support.</p>
                    <div class="support-contacts">
                        <a href="tel:+251-XX-XXX-XXXX" class="support-link">
                            <i class="fas fa-phone"></i>
                            Emergency: +251-XX-XXX-XXXX
                        </a>
                        <a href="mailto:admin@gobahospital.com" class="support-link">
                            <i class="fas fa-envelope"></i>
                            admin@gobahospital.com
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="security-notice">
        <div class="container">
            <div class="notice-content">
                <i class="fas fa-shield-alt"></i>
                <div>
                    <h4>Maximum Security Access</h4>
                    <p>All admin activities are logged and monitored. Unauthorized access attempts will be reported.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            if (password.length < 8) {
                e.preventDefault();
                showAlert('Admin password must be at least 8 characters long.', 'error');
                return;
            }
        });
        ...
        // Additional security: Disable right-click context menu on admin portal
