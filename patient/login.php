...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        try {
            $stmt = $db->prepare("SELECT pl.*, p.first_name, p.last_name, p.ssn FROM patient_login pl 
                                 JOIN patient p ON pl.ssn = p.ssn 
                                 WHERE pl.username = ?");
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="text-center mb-4">
                ...
                <h2>Patient Login</h2>
                <p class="text-muted">Access your medical records and information</p>
            </div>
